								...
								<tbody>
									...
									<table class="matable" width="770px">
										<tbody>
											...
											<tr>
												<td class="montd" witdh="200px"> 
													Avertissement sur l'usage: <p/>
													INSPIRE Conditions applicables à l’accès et à l’utilisation:
											...
											<!-- accessConstraints / Contraintes d'accès --> 
											 <tr>
												<td class="montd"> 
													Conditions à respecter pour l'accès:
													<!-- <xsl:call-template name="get_property">
											...
											<tr>
												<td class="montd" witdh="200px"> 
													Autres conditions liées à l'accès: <p/>
													INSPIRE Restrictions concernant l’accès public:
													<!-- <xsl:call-template name="get_property">
